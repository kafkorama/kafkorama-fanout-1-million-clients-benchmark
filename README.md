...
You can think of Kafkorama as a *streaming-based API management solution* for Apache Kafka, analogous to traditional REST-based API management with the usual components: an API Portal and a Gateway. But above all, Kafkorama extends Kafka to real-time web, mobile, or IoT apps at scale.
