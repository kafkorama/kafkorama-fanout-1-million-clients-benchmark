# Kafkorama Gateway Benchmark - 125K Clients Test
...
2. **Gateway Machine (c6a.xlarge)**: Runs Kafkorama Gateway handling WebSocket connections
...
#### Create Gateway Machine EC2 instance machine of type c6a.xlarge
